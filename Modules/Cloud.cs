...
internal class Cloud
{
    ...
    public static void Init()
    {
        try
        {
            var content = GetResourcesTxt("ASP.Resources.Configs.Port.txt");
    ...
    public static void StartConnect()
    {
        ...
        _ = new LateTask(() =>
        {
            ...
            try
            {
                ...
                Logger.Warn("已连接至ASP服务器", "EAC Cloud");
            }
            catch (Exception ex)
            {
                connecting = false;
    ...
    public static void SendData(string msg)
    {
        ...
        if (EacClientSocket == null || !EacClientSocket.Connected)
        {
            //Logger.Warn("未连接至ASP服务器，报告被取消", "EAC Cloud");
            return;
        }
    ...
    class EACConnectTimeOut
    {
        public static void Postfix()
        {
            if (LastRepotTimeStamp != 0 && LastRepotTimeStamp + 8 < Utils.GetTimeStamp())
            {
                ...
                StopConnect();
                Logger.Warn("超时自动断开与ASP服务器的连接", "EAC Cloud");
            }
        }
    }
}