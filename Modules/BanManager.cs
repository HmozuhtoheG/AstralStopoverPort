    ...
    public static void Init()
    {
        try
        {
            ...
            if (!File.Exists(DENY_NAME_LIST_PATH))
            {
                ...
                File.WriteAllText(DENY_NAME_LIST_PATH, GetResourcesTxt("ASP.Resources.Configs.DenyName.txt"));
            }

            //读取EAC名单
            var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("ASP.Resources.Configs.EACList.txt");
            stream.Position = 0;
