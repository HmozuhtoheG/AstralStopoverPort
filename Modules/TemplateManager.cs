...
public static class TemplateManager
{
    ...
    public static void CreateIfNotExists()
    {
        if (!File.Exists(TEMPLATE_FILE_PATH))
        {
            try
            {
                ...
                else
                {
                    ...
                    File.WriteAllText(TEMPLATE_FILE_PATH, GetResourcesTxt($"ASP.Resources.MsgTemplates.{fileName}.txt"));
                }
            }
            catch (Exception ex)
            {
        ...
        else
        {
            ...
            File.WriteAllText(TEMPLATE_FILE_PATH, text.Replace("tohe.cc", "asp.cc"));
        }
    }
