...
public static class RegistryManager
{
    ...
    public static RegistryKey Keys = SoftwareKeys?.OpenSubKey("AU-ASP", true);
#endif
    ...
    public static void Init()
    {
        ...
        if (Keys == null)
        {
            Logger.Info("Create ASP Registry Key", "Registry Manager");
            Keys = SoftwareKeys?.CreateSubKey("AU-ASP", true);
        }
        if (Keys == null)
        {
        ...
        Logger.Warn("上次启动的ASP版本：" + LastVersion, "Registry Manager");
        ...
        if (LastVersion <= new Version(3, 0, 0))
        {
            ...
            FoldersNFileToDel.Add(@"./ASP/Data/template.txt");
        }
#endif
