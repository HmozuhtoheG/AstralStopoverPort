using TMPro;
using ASP.Modules;
using ASP.Modules.OptionItems;
using ASP.Modules.OptionItems.Interfaces;
using UnityEngine;
...
public static class GameSettingMenuPatch
{
    ...
    public static void Start_Postfix(GameSettingMenu __instance)
    {
        ...
        foreach (var tab in Enum.GetValues(typeof(TabGroup)))
        {
            ...
            // 生成Tab图标
            var settingsImage = CreateTabImage(__instance, settingsTab, $"ASP.Resources.Images.TabIcon_{tab}.png");
...
public class ToggleOptionInitializePatch
{
    public static void Postfix(ToggleOption __instance)
    {
        ...
        __instance.CheckMark.sprite = Utils.LoadSprite("ASP.Resources.Images.UI.CheckMark.png", 100f);
