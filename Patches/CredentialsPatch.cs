...
internal class VersionShowerStartPatch
{
    ...
    private static void Postfix(VersionShower __instance)
    {
        ...
        Main.CredentialsText = $"\r\n<color={Main.ModColor}>{Main.ModName}</color> - {Main.PluginVersion}Beta";
#if DEBUG
...
internal class TitleLogoPatch
{
    ...
    private static void Postfix(MainMenuManager __instance)
    {
        ...
        TONX_Background = new GameObject("ASP Background")
        {
            transform =
            {
        ...
        bgRenderer.sprite = Utils.LoadSprite("ASP.Resources.Images.ASP-BG.jpg", 179f);
        ...
        closeRightSpriteRenderer.sprite = Utils.LoadSprite("ASP.Resources.Images.RightPanelCloseButton.png", 100f);
        ...
        logoRenderer.sprite = Utils.LoadSprite("ASP.Resources.Images.ASP-Logo.png");
