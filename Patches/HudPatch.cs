...
class HudManagerInitializePatch
{
    ...
    public static void CreateRoleInfoButton()
    {
        ...
        RoleInfoButton.inactiveSprites.GetComponent<SpriteRenderer>().sprite = Utils.LoadSprite("ASP.Resources.Images.UI.RoleInfoButton-inactive.png", 100f);
        RoleInfoButton.activeSprites.GetComponent<SpriteRenderer>().sprite = Utils.LoadSprite("ASP.Resources.Images.UI.RoleInfoButton-active.png", 100f);
        RoleInfoButton.selectedSprites.GetComponent<SpriteRenderer>().sprite = Utils.LoadSprite("ASP.Resources.Images.UI.RoleInfoButton-selected.png", 100f);
