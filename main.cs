...
[assembly: AssemblyFileVersion(ASP.Main.PluginVersion)]
[assembly: AssemblyInformationalVersion(ASP.Main.PluginVersion)]
[assembly: AssemblyVersion(ASP.Main.PluginVersion)]
namespace ASP;

[BepInPlugin(PluginGuid, "ASP", PluginVersion)]
[BepInIncompatibility("jp.ykundesu.supernewroles")]
[BepInProcess("Among Us.exe")]
public class Main : BasePlugin
{
    // == 程序基本设定 / Program Config ==
    public static readonly string ModName = "星驿港-Beta";
    public static readonly string ModColor = "#0F1A3D";
    public static readonly Color32 ModColor32 = new(255, 173, 240, 240);
    public static readonly bool AllowPublicRoom = true;
    public static readonly string ForkId = "ASP-Beta";
    public const string OriginalForkId = "OriginalTONX";
    public const string PluginGuid = "cn.karped1em.keno";
...
#pragma warning restore CS0618
    ...
    public override void Load()
    {
        ...
        //Client Options
        HideName = Config.Bind("Client Options", "Hide Game Code Name", "ASP");
        ...
        Logger = BepInEx.Logging.Logger.CreateLogSource("ASP");
        ASP.Logger.Enable();
        ASP.Logger.Disable("NotifyRoles");
        ASP.Logger.Disable("SwitchSystem");
        ASP.Logger.Disable("ModNews");
        ASP.Logger.Disable("CustomRpcSender");
        if (!DebugModeManager.AmDebugger)
        {
            ASP.Logger.Disable("CheckRelease");
            ASP.Logger.Disable("CustomRpcSender");
            //ASP.Logger.Disable("ReceiveRPC");
            ASP.Logger.Disable("SendRPC");
            ASP.Logger.Disable("SetRole");
            ASP.Logger.Disable("Info.Role");
            ASP.Logger.Disable("TaskState.Init");
            //ASP.Logger.Disable("Vote");
            ASP.Logger.Disable("RpcSetNamePrivate");
            //ASP.Logger.Disable("SendChat");
            ASP.Logger.Disable("SetName");
            //ASP.Logger.Disable("AssignRoles");
            //ASP.Logger.Disable("RepairSystem");
            //ASP.Logger.Disable("MurderPlayer");
            //ASP.Logger.Disable("CheckMurder");
            ASP.Logger.Disable("PlayerControl.RpcSetRole");
            ASP.Logger.Disable("SyncCustomSettings");
        }
        //ASP.Logger.isDetail = true;
        ...
        {
            ASP.Logger.Error("错误：字典出现重复项", "LoadDictionary");
            ASP.Logger.Exception(ex, "LoadDictionary");
        ...
        ASP.Logger.Info($"{Application.version}", "AmongUs Version");

        var handler = ASP.Logger.Handler("GitVersion");
        ...
        ASP.Logger.Msg("========= ASP loaded! =========", "Plugin Load");
    }
}
