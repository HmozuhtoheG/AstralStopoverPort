...
using ASP.Roles.Core.Descriptions;
using UnityEngine;
using static ASP.Options;

namespace ASP.Roles.Core;
...
public class SimpleRoleInfo
{
    ...
    internal static SimpleRoleInfo Create(Type type, Func<PlayerControl, RoleBase> value1, CustomRoles ldwy, Func<RoleTypes> value2, CustomRoleTypes crewmate, int v1, int v, string v2, string v3, bool v4, Func<AudioClip> introSound)
    {
        throw new NotImplementedException();
    }

    internal static SimpleRoleInfo Create(Type type, Func<PlayerControl, RoleBase> value1, object recruitInfo, Func<RoleTypes> value2, CustomRoleTypes crewmate, int v1, int v, string v2, string v3, bool v4, Func<AudioClip> introSound)
    {
        throw new NotImplementedException();
    }
